          ...
          <v-card height="250px" tile flat color="#3890D8">
            <v-row>
              <v-col cols="12" sm="4" class="pl-8 pt-5">
                <v-btn color="black" dark class="withoutuppercase" small tile>new</v-btn>
          ...
          <v-card height="250px" tile flat color="#6857E1">
            <v-row>
              <v-col cols="12" sm="6" class="pl-8 pt-5">
                ...
                <v-btn rounded color="#8375E7" dark class="withoutuppercase px-8 mt-3">More Info</v-btn>
              </v-col>
              <v-col cols="12" sm="6">
